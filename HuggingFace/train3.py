...
def main():
    ...
    # Load training data
    training_data_path = os.path.join(os.path.dirname(__file__), "datasets", "chime_train.json")
    with open(training_data_path, "r") as f:
        training_data = json.load(f)

    # Load validation data
    validation_data_path = os.path.join(os.path.dirname(__file__), "datasets", "chime_val.json")
    with open(validation_data_path, "r") as f:
        validation_data  = json.load(f)

    # Load test data
    test_data_path = os.path.join(os.path.dirname(__file__), "datasets", "chime_test.json")
    with open(test_data_path, "r") as f:
        test_data  = json.load(f)

    # Prepare datasets
    train_dataset = prepare_training_data(training_data, tokenizer, device)
